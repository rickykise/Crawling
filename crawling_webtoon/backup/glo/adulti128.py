...
def startCrawling():
    ...
    while check:
        ...
        try:
            for item in div:
                url = 'https://adulti128.com'+item.find('a')['href']
...
if __name__=='__main__':
    ...
    print("adulti128 크롤링 시작")
    startCrawling()
    print("adulti128 크롤링 끝")
