...
def startCrawling():
    ...
    while check:
        ...
        try:
            for item in div:
                url = 'https://www.gogotoon01.com'+item.find('a')['href']
...
if __name__=='__main__':
    ...
    print("gogotoon01 크롤링 시작")
    startCrawling()
    print("gogotoon01 크롤링 끝")
