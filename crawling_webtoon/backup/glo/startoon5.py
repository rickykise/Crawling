...
def startCrawling(site):
    i = 0;check = True
    link = 'https://startoon5.com/bbs/board.php?bo_table=webtoon'+site+'&page='
    while check:
        i = i+1
        if i == 30:
            break
        ...
        try:
            for item in li:
                url = 'https://startoon5.com/bbs'+item.find('a')['href'].split('/bbs')[1].split('&page')[0].strip()
...
if __name__=='__main__':
    ...
    print("startoon5 크롤링 시작")
    site = ['1','2','3','4']
    for s in site:
        startCrawling(s)
    print("startoon5 크롤링 끝")
