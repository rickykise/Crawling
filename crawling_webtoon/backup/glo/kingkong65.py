...
def startCrawling(site):
    i = 0;check = True
    link = 'https://kingkong65.com/웹툰'+site
    while check:
        i = i+1
        if i == 2:
            break
        ...
        try:
            for item in div:
                url = 'https://kingkong65.com'+item.find('a')['href']
...
if __name__=='__main__':
    ...
    print("kingkong65 크롤링 시작")
    site = ['','미리보기/완결']
    for s in site:
        startCrawling(s)
    print("kingkong65 크롤링 끝")
