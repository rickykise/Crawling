...
def startCrawling():
    i = 0;check = True
    link = 'https://www.chcomics16.com/웹툰/요일/'
    ...
    for v in val:
        ...
        try:
            for item in div:
                url = 'https://chcomics16.com'+item.find('a')['href']
                ...
                for item in tr:
                    craw_url = 'https://chcomics16.com'+item.find('a')['href']
                    title_num = item.find('div', 'num').text.strip()

                    data = {
                        'craw_osp_id': 'chcomics16',
                        'craw_domain': 'com',
                        'craw_title': title,
                        'craw_site_url' : url,
                        'craw_url': craw_url,
...
if __name__=='__main__':
    ...
    print("chcomics16 크롤링 시작")
    startCrawling()
    print("chcomics16 크롤링 끝")
