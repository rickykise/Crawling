...
def startCrawling():
    ...
    while check:
        ...
        li = soup.find_all('div', 'section-item-title')

        try:
            for item in li:
                url = 'https://hodu210.com'+item.find('a')['href']
                ...
                for item in tr:
                    craw_url = 'https://hodu210.com'+item['onclick'].split("href='")[1].split("'")[0].strip()
