...
def startCrawling():
    i = 0;check = True
    link = 'https://www.sharktoon10.com/웹툰'
    while check:
        i = i+1
        if i == 2:
            break
        ...
        try:
            for item in div:
                url = 'https://www.sharktoon10.com'+item.find('a')['href']
...
if __name__=='__main__':
    ...
    print("sharktoon10 크롤링 시작")
    startCrawling()
    print("sharktoon10 크롤링 끝")
