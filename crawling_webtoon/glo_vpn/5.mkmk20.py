...
def startCrawling():
    ...
    while check:
        ...
        try:
            for item in div:
                url = 'https://5.mkmk20.com'+item.find('a')['href']
...
if __name__=='__main__':
    ...
    print("5.mkmk20 크롤링 시작")
    startCrawling()
    print("5.mkmk20 크롤링 끝")
