...
def getSearchUrl(cnt_osp):
    with conn.cursor() as curs:
        sql = "select cnt_url, cnt_chk_2 from cnt_f_m_detail where cnt_date_1 >= '2019-05-14 00:00:00' and (cnt_osp = '"+cnt_osp+"' and cnt_chk_1 = 0 and cnt_chk_2 is null) or (cnt_osp = '"+cnt_osp+"' and cnt_chk_1 = 0 and cnt_chk_2 = 0 and cnt_chk_3 is null) order by n_idx desc;"
        curs.execute(sql)
