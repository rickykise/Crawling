...
def startCrawling(site):
    i = 0;check = True
    link = 'https://dramawheel.com/'+site+'/page/'
    while check:
        i = i+1
        if i == 30:
            break
            ...
            for item in article:
                ...
                if soup.find('ul', 'episodios'):
                    ...
                    for item in li:
                        ...
                        for item in li:
                            host_link = 'https://dramawheel.com/wp-admin/admin-ajax.php'
                            nume = item['data-nume']
                            post = item['data-post']
                            data = {
...
if __name__=='__main__':
    ...
    print("dramawheel 크롤링 시작")
    site = ['tvshows','episodes']
    for s in site:
        startCrawling(s)
    print("dramawheel 크롤링 끝")
