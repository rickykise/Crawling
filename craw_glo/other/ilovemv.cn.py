...
def startCrawling():
    i = 0;check = True
    link = 'http://ilovemv.cn/index.php/vod/show/id/15/page/{}.html'
    while check:
        i = i+1
        if i == 13:
            break
        ...
        try:
            for item in li:
                url = 'http://ilovemv.cn'+item.find('a', 'fed-list-title')['href']
                ...
                for item in div:
                    ...
                    for item in li:
                        if item.find('a', 'fed-btns-info') == None:
                            continue
                        host_url = 'http://ilovemv.cn'+item.find('a', 'fed-btns-info')['href']
...
if __name__=='__main__':
    ...
    print("ilovemv.cn 크롤링 시작")
    startCrawling()
    print("ilovemv.cn 크롤링 끝")
