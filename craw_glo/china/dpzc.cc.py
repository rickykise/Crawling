...
def startCrawling():
    i = 0;check = True
    link = 'http://dpzc.cc/maccms10/index.php/vod/show/area/%E9%9F%A9%E5%9B%BD/id/11/page/{}.html'
    while check:
        i = i+1
        if i == 13:
            break
        ...
        try:
            for item in li:
                url = 'http://dpzc.cc'+item.find('a','fed-list-title')['href']
                ...
                for item in div:
                    ...
                    for item in li:
                        if item.find('a','fed-btns-info') == None:
                            continue
                        host_url = 'http://dpzc.cc'+item.find('a','fed-btns-info')['href']
