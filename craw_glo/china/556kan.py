...
def startCrawling():
    i = 0;check = True
    link = 'https://www.556kan.com/vodshow/15-%E9%9F%A9%E5%9B%BD-------{}---.html'
    while check:
        i = i+1
        if i == 27:
            break
        ...
        try:
            for item in li:
                url = item.find('a','fed-list-title')['href']
                ...
                for item in div:
                    ...
                    for item in li:
                        if item.find('a','fed-btns-info') == None:
                            continue
                        host_url = 'https://www.556kan.com'+item.find('a','fed-btns-info')['href']
