        ...
        while check:
            ...
            try:
                for item in li:
                    ...
                    url = 'https://www.52ys.tv'+item.find('a','fed-list-title')['href']
                    ...
                    for item in div:
                        ...
                        for item in li:
                            if item.find('a','fed-btns-info') == None:
                                continue
                            host_url = 'https://www.52ys.tv'+item.find('a','fed-btns-info')['href']
...
if __name__=='__main__':
    ...
    print("52ys 크롤링 시작")
    site=[['https://www.52ys.tv/vod/show/area/%E9%9F%93%E5%9C%8B/id/15/page/{}.html',30],['https://www.52ys.tv/vod/show/area/%E9%9F%93%E5%9C%8B/id/3/page/{}.html',21]]
    for item in site:
        startCrawling(item)
    print("52ys 크롤링 끝")
