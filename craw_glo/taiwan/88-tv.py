        ...
        while check:
            ...
            try:
                for item in li:
                    ...
                    url = 'https://www.88-tv.com'+item.find('a','fed-list-title')['href']
                    ...
                    for item in div:
                        ...
                        for item in li:
                            if item.find('a','fed-btns-info') == None:
                                continue
                            host_url = 'https://www.88-tv.com'+item.find('a','fed-btns-info')['href']
...
if __name__=='__main__':
    ...
    print("88-tv 크롤링 시작")
    site=[['https://www.88-tv.com/vod/show/id/15/page/{}.html',30],['https://www.88-tv.com/vod/show/area/%E9%9F%93%E5%9C%8B/id/{}.html',21]]
    for item in site:
        startCrawling(item)
    print("88-tv 크롤링 끝")
