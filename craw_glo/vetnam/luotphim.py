...
def startCrawling(site):
    i = 0;check = True
    link = 'https://luotphim.com/genre/'+site+'/page/'
    while check:
        i = i+1
        if i == 30:
            break
        ...
        try:
            for item in article:
                ...
                titleSub = item.find('div', 'data').text.strip()
                if titleSub.find('(') != -1:
                ...
                for item in li:
                    ...
                    titleNum = item.find('div', 'episodiotitle').find('a').text.strip()
...
if __name__=='__main__':
    ...
    print("luotphim 크롤링 시작")
    site = ['phim-han-quoc', 'phim-le-han-quoc', 'korean-variety-shows']
    for s in site:
        startCrawling(s)
    print("luotphim 크롤링 끝")
