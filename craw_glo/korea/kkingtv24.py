...
def startCrawling(site):
    i = 0;check = True
    link = 'http://a28.kkingtv24.com/home1?c='+site+'&s=0&f=0&p='
    while check:
        if i == 30:
            break
        ...
        try:
            for item in div:
                url = 'http://a28.kkingtv24.com'+item.find('a')['href']
                ...
                for item in div:
                    host_url = 'http://a28.kkingtv24.com'+item.find('a')['href']
                    title = item.find('a').find('div').text.strip().replace('\n', '')
                    title_null = titleNull(title)
                    ...
                    host_url = 'http://a28.kkingtv24.com/a03?d=0&a=1&c=0&n=0&x='+xNum
...
if __name__=='__main__':
    ...
    print("kkingtv24 크롤링 시작")
    site = ['0', '1', '2']
    for s in site:
        startCrawling(s)
    print("kkingtv24 크롤링 끝")
