...
def startCrawling(site):
    i = 0;check = True;cnt_osp = 'l3.leadership14'
    ...
    if group_id != None:
        ...
        link = 'https://l3.leadership14.site/bbs/board.php?bo_table='+site+'&page='
    while check:
        i = i+1
        if i == 30:
            break
...
if __name__=='__main__':
    ...
    print("l3.leadership14 크롤링 시작")
    site = ['dramakor', 'dramaend', 'enter']
    for s in site:
        startCrawling(s)
    print("l3.leadership14 크롤링 끝")
