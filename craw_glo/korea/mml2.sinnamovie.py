...
def startCrawling(site):
    i = 0;check = True
    link = 'https://mml2.sinnamovie.net/bbs/board.php?bo_table='+site+'&page='
    while check:
        i = i+1
        if i == 30:
            break
        ...
        try:
            for item in tr:
                ...
                for item in div:
                    ...
                    url2 = 'https://mml2.sinnamovie.net/player_url.php?id='+id+'&bo='+bo
                    headers = {
...
if __name__=='__main__':
    ...
    print("mml2.sinnamovie 크롤링 시작")
    site = ['drama_new', 'drama', 'enter_new', 'enter']
    for s in site:
        startCrawling(s)
    print("mml2.sinnamovie 크롤링 끝")
