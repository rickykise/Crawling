...
def startCrawling(site):
    i = 0;check = True
    link = 'https://toto-play1.com/bbs/board.php?bo_table=tv'+site+'&page='
    while check:
        i = i+1
        if i == 30:
            break
        ...
        try:
            for item in li:
                ...
                c = r.content
                soup = BeautifulSoup(c,"html.parser")
                sub = soup.find('div', 'view-content').find_all('center')
...
if __name__=='__main__':
    ...
    print("toto-play1 크롤링 시작")
    site = ['drama', 'enter']
    for s in site:
        startCrawling(s)
    print("toto-play1 크롤링 끝")
