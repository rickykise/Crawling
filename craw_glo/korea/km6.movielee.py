...
def startCrawling(site):
    i = 0;check = True
    link = 'https://km6.movielee.com/bbs/board.php?bo_table='+site+'&page='
    while check:
        i = i+1
        if i == 30:
            break
...
if __name__=='__main__':
    ...
    print("km6.movielee 크롤링 시작")
    site = ['drama_new', 'enter_new', 'drama', 'enter']
    for s in site:
        startCrawling(s)
    print("km6.movielee 크롤링 끝")
