...
def startCrawling(site):
    i = 0;check = True;cnt_osp = 'h50.hohotv'; osp_link = 'https://h50.hohotv.xyz'
    ...
    if group_id != None:
        ...
        link = 'https://h50.hohotv.xyz/'+site+'/p'
    while check:
        checkSub = True
        i = i+1
        if i == 30:
            ...
            for item in div:
                ...
                if soup.find('button', 'baseLinkButton malibu'):
                    ...
                    for item in td:
                        ...
                        c = r.content
                        soup = BeautifulSoup(c,"html.parser")
                        sub = soup.find_all('a', 'baseLinkButton', style="width:50%")
