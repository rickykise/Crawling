...
def startCrawling(site):
    i = 0;check = True; subI = 0; check_Title = ''; firstCheck = True;cnt_osp = 'tvbongbong'
    getGroup = groupCheck(osp_id)
    group_id = getGroup['id']
    group_url = getGroup['url']
    if group_id != None:
        link = group_url+'playlist/cat_js/'+site+'?page='
        cnt_osp = group_id
    else:
        link = 'https://www.tvbongbong.bar/playlist/cat_js/'+site+'?page='
    while check:
        checkSub = True
        i = i+1
        if i == 30:
        ...
        try:
            for item in li:
                ...
                page_url = group_url+'playlist/page_in_detailjs/'+cnt_num+'/'
...
if __name__=='__main__':
    ...
    print("tvbongbong 크롤링 시작")
    site = ['2', '1']
    for s in site:
        startCrawling(s)
    print("tvbongbong 크롤링 끝")
