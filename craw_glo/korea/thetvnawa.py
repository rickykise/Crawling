...
def startCrawling(site):
    i = 0;check = True;a = 0;checkRe = True;cnt_osp = 'thetvnawa'
    if site == '1':
        cate = ['1', '2', '4']
        for c in cate:
            ...
            if group_id != None:
                ...
                link = 'https://www.thetvnawa.rest/playlist/mod_playlist_sort_js/'+c+'/0?page='
            while check:
                i = i+1
                if i == 30:
                    break
...
if __name__=='__main__':
    ...
    print("thetvnawa 크롤링 시작")
    site = ['1', '2']
    for s in site:
        startCrawling(s)
    print("thetvnawa 크롤링 끝")
