...
def startCrawling():
    i = 0;check = True
    link = 'http://iddramatv.com/country/korea?page='
    while check:
        i = i+1
        if i == 30:
            break
        ...
        try:
            for item in li:
                imgUrl = item.find('div', 'ratio-content')['style'].split("image:url('")[1].split("')")[0].strip()
...
if __name__=='__main__':
    ...
    print("iddramatv 크롤링 시작")
    startCrawling()
    print("iddramatv 크롤링 끝")
