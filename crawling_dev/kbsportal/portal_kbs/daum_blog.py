    ...
    try:
        ...
        while True:
            ...
            for item in data['documents']:
                ...
                if item['url'].find('naver') != -1 or item['datetime'].strftime('%Y-%m-%d') < '2019-03-13':
                    continue
                ...
                if result:
                    ...
                    try:
                        ...
                        insert(conn2,'blog','daum',item['title'],item['blogname'],item['datetime'],dbKey[key]['add'][0],putKey,'',item['url'])
