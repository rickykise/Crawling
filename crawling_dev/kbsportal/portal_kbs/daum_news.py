...
def startCrawling(key):
    ...
    driver.get("https://search.daum.net/search?w=news&sort=recency&q="+key+"&cluster=n&DA=PGD&s=NS&a=STCF&dc=STC&pg=1&r=1&p=1&rc=1&at=more&sd=20190313000000&ed=20190422235959&period=u")
    try:
        print("키워드 :",key)
        ...
        while True:
            ...
            for item in findLI:
                ...
                if result:
                    ...
                    url = mediaUrl['u']
                    if media_name != None and url != None: continue
