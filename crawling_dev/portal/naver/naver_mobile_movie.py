...
def main():
    ...
    try:
        ...
        time.sleep(3)
        # driver.find_element_by_xpath('//*[@id="MM_aside_popup_notification"]/div/div/button[1]').click()
        # time.sleep(3)
        driver.find_element_by_xpath('//*[@id="MM_aside_switch_version_btn"]/span').click()
        time.sleep(3)
        # driver.find_element_by_xpath('//*[@id="t18"]/div/div[2]/button[2]').click()
        # time.sleep(5)
        driver.find_element_by_xpath('//*[@id="nav"]/a').click()
        time.sleep(3)
        ...
        soup = BeautifulSoup(html,"html.parser")
        tagLi = ['cc_text_item','cc_citem']
        for t in tagLi:
            li = soup.find('div','brick-vowel').find_all('li',t)
