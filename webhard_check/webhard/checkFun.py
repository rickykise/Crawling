...
def getSearchUrl(cnt_osp):
    with conn.cursor() as curs:
        ...
        sql = "select cnt_url, cnt_chk_2 from cnt_f_detail where cnt_osp = '"+cnt_osp+"' and cnt_chk_1 = 0 and cnt_chk_2 is null order by n_idx desc ;"
        curs.execute(sql)
...
#         sql = "SELECT k_title, k_cp, cnt_price FROM cnt_keyprice where k_mcp not in ('jaye', 'warner') and k_state = 1;"
#         curs.execute(sql)
#         result = curs.fetchall()
#
#         returnValue = {}
