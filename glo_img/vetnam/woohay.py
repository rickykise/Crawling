...
def startCrawling():
    i = 0;check = True
    link = 'https://woohay.com/quoc-gia/phim-han-quoc/page-'
    while check:
        i = i+1
        if i == 30:
            break
        ...
        try:
            for item in li:
                imgUrl = item.find('img')['src'].split('url=')[1].split('jpg')[0]+'jpg'
                imgUrl = urllib.parse.unquote(imgUrl)
                url = 'https://woohay.com/'+item.find('a')['href']
                ...
                c = r.content
                soup = BeautifulSoup(c,"html.parser")
                url2 = 'https://woohay.com/'+soup.find('div', 'btn-groups').find('a', 'btn-watch')['href']
                ...
                for item in li:
                    host_url = 'https://woohay.com/'+item.find('a')['href']
