...
def startCrawling():
    i = 0;check = True
    link = 'https://www.dongphim.net/content/search?t=ft&gr=&nt=KR&y=&mt=&p='
    while check:
        if i == 30:
            break
        ...
        try:
            for item in div:
                ...
                c = r.content
                soup = BeautifulSoup(c,"html.parser")
                div2 = soup.find('div', 'movie-eps').find_all('a', 'movie-eps-item')
...
if __name__=='__main__':
    ...
    print("dongphim 크롤링 시작")
    startCrawling()
    print("dongphim 크롤링 끝")
