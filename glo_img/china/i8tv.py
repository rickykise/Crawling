...
def startCrawling():
    ...
    while check:
        ...
        try:
            for item in li:
                url = 'https://www.i8tv.net'+item.find('div', 'video-info').find('a')['href']
                imgUrl = 'https://www.i8tv.net'+ item.find('img')['data-original']
                titleSub = item.find('div', 'video-info').find('a').text.strip()
                ...
                c = r.content
                soup = BeautifulSoup(c,"html.parser")
                li = soup.find('div', id='detail-content').find_all('li')

                for item in li:
                    host_url = 'https://www.i8tv.net'+item.find('a')['href']
