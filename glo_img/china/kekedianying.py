...
def startCrawling(site):
    i = 0;check = True
    link = 'http://kekedianying.com/index.php?m=vod-list-id-'+site+'-pg-'
    ...
    while check:
        ...
        try:
            for item in li:
                ...
                url = 'http://kekedianying.com'+item.find('a')['href']
                ...
                for item in ul:
                    li = item.find_all('li')
                    for item in li:
                        host_url = 'http://kekedianying.com'+item.find('a')['href']
                        title = titleSub+'_'+item.find('a').text.strip()
                        title_null = titleNull(title)

                        data = {
                            'cnt_id': cnt_id,
                            'cnt_osp' : 'kekedianying',
                            'cnt_title': title,
...
if __name__=='__main__':
    ...
    print("kekedianying 크롤링 시작")
    site = ['14','3']
    for s in site:
        startCrawling(s)
    print("kekedianying 크롤링 끝")
