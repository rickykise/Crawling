...
def startCrawling(key):
    ...
    with requests.Session() as s:
        i = 0;check = True
        link = 'http://sedisk.com/storage.php?act=asyncList&banner_keyword=&searchKey=&searchValue=&search_keyword_hidden=&search_type=&search_keyword=&search=&useridx=&section=&search='+encText+'&sub_sec=&nPage='
        ...
        while check:
            ...
            try:
                for item in tr:
                    ...
                    # if keyCheck['m'] == None:
                    #     dbResult = insertDB('sedisk',title,title_null,url)
                    #     continue
