...
#     soup = BeautifulSoup(c,"html.parser")
    ...
    # div2 = soup.find('div', id='clipInfoArea')
    # # print(div2)
    #
    ...
    # if div2.find('div', 'watch_btn').find('span','count _commentCount').text.strip() == '':
    #     reply_cnt = 0
    # else:
    #     reply = div2.find('div', 'watch_btn').find('span','count _commentCount').text.strip()
