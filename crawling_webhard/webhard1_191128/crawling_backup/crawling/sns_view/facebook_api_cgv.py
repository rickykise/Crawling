...
def fetch_feed(pageKey):
    ...
    for idx,value in enumerate(post_json['data']):
        try:
            ...
            print(value['link'])
            print(setContent(value['message']))
            print(GetSubcontents)
            print('==========================')
            ...
            # insert(conn2,pageKey,setContent(value['message']),GetSubcontents,value['link'],str(value['likes']['summary']['total_count']),str(value['comments']['summary']['total_count']),str(value['shares']['count']),view_get,setDate(value['created_time']))
