...
def startCrawling(key):
    print("키워드 : ",key)
    i = 0;
    link = 'http://extmovie.maxmovie.com/xe/index.php?_filter=search&mid=movietalk&search_target=title&search_keyword='+key+'&page='
    ...
    while check:
        ...
        for item in tr:
            ...
            # if data['date'] < '2018-02-25': check=False;break
            # print(data)
