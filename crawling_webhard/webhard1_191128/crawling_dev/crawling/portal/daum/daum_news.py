            ...
            for item in findLI:
                ...
                if result:
                    ...
                    try:
                        ...
                        dbResult = insert(conn,'media',reporter_media_name,data['title'],data['contents'],data['pubDate'],dbKey[key]['add'][0],putKey,k_type,data['url'],reporter_name,None,None,media_subname,media_main)
                        insert(conn2,'media',reporter_media_name,data['title'],data['contents'],data['pubDate'],dbKey[key]['add'][0],putKey,k_type,data['url'],reporter_name,None,None,media_subname,media_main)
                        if dbResult:
                            check=True;break
                        else:
