...
#     'm_pwd': 'up0003',
#     'nowHost': 'me2disk.com',
#     'nowPage': '%2Fcontents%2Findex.htm',
#     'site_set': 'me2disk'
# }
...
def startCrawling(site):
    ...
    with requests.Session() as s:
        ...
        link = "http://me2disk.com/contents/index.htm?category1="+site+"&category2=&s_word=&viewTab=new&adultEx=Y&rows=25&page="
        while check:
            i = i+1
            if i == 4:
                break
            # login_req = s.post('https://ssl.me2disk.com/member/loginCheck.php', data=LOGIN_INFO)
