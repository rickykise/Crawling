...
from bs4 import BeautifulSoup as bs
   ...
   # Accept-Language:
   # :
   # Cookie: idx01=1212872; bbs_history=%5B%221212988%22%2C%221212903%22%2C%221212518%22%5D;
   # Host:
   # User-Agent:
...
def startCrawling(site):
    ...
    with requests.Session() as s:
        while check:
            ...
            if i == 10:
                break
            link = "https://m.filebogo.com/storage.php?act=list&mSec="+site+"&sSec=all&Limit=20&Page="+str(i)
            ...
            try:
                for item in li:
                    ...
                    url = 'https://m.filebogo.com/storage.php?act=view&idx='+cnt_num+'&mSec='+site+'&sSec=all'
