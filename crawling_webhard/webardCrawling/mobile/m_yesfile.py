        ...
        while check:
            ...
            try:
                for item in text:
                    ...
                    if soup.find('div', 'fileinfo_textarea').find_all('li', 'info_a')[1].find('img'):
                        cnt_price = soup.find('div', 'fileinfo_textarea').find_all('li', 'info_a')[1].text.split('P')[1].split('P')[0].replace(",","").strip()
                        cnt_chk = 1
                    elif soup.find('div', 'fileinfo_textarea').find_all('li', 'info_a')[1].find('span'):
