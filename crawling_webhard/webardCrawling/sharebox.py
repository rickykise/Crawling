...
def startCrawling(site):
    ...
    with requests.Session() as s:
        login_req = s.post('https://ssl.sharebox.co.kr/login/', data=LOGIN_INFO)
        ...
        while check:
            ...
            with requests.Session() as s:
                headers2 = {'Cookie': 'PHPSESSID=qltpvt438ueeahstm72rv71jk4; no_error=1; SHL=MTYwOTk5OTQxMQ%3D%3D; _ga=GA1.3.1542067594.1609999414; _gid=GA1.3.1295967694.1609999414; _gat=1; auth500_event=1'}
