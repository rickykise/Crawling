...
#insertall
def insertALL(data):
    connOto = pymysql.connect(host='49.247.5.160',user='otogreen',password='sms@unionc',db='otogreen',port=3306,charset='utf8')
...
def insertDB(cnt_osp,cnt_title,title_null,cnt_url):
    ...
    try:
        ...
        connBack = pymysql.connect(host='61.82.113.197',user='autogreen',password='uni1004',db='site',port=3307,charset='utf8')
        curs2 = connBack.cursor(pymysql.cursors.DictCursor)
        dbResult = insert2(connBack,cnt_osp,cnt_title,title_null,cnt_url)
        connBack.close()
    except:
        pass
