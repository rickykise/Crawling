    ...
    try:
        with requests.Session() as s:
            LOGIN_INFO = {
                'Frame_login': 'Ok',
                'keep': 'Y',
                'm_id': 'NBW8LBv5RnOUrfhZlGpQO5JaHAqVGZBo1Tb+0shE3gA=||vWxjusre0d1843d854e19a36fdc058ebc6c19b6',
                'm_pwd': 'FBlA9hPtOMLBdoGqgPmcSw==||lJl2Rsnc210a9659ff7d2b426371894dc969b1a',
                'view_login': 'N'
            }
...
# def main():
#     cnt_id = 'daoki'
#     url = 'http://daoki.com/contents/view.htm?idx=5983217&aes=EklLk5V8YBnGFVClg+uu4enqRRAaFi2n1mnr8KmS3d0='
