...
# url 가져오는 함수
def getSearchUrl(url, cnt_id):
    with conn.cursor() as curs:
        sql = "SELECT cnt_url, cnt_price FROM otogreen.cnt_all where cnt_osp = 'filekuki' and cnt_price = '10' order by cnt_regdate desc limit 50;"
        curs.execute(sql)
