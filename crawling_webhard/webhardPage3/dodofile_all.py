    ...
    with requests.Session() as s:
        while check:
            try:
                ...
                # if i == 4:
                #     break
                link = 'http://www.dodofile.com/board.php?act=asyncList&search_type=ALL&section=ALL&nPage='+str(i)+'&act=asyncList&mode=&s_act=&nLimit=100&search='+key+'&_=1548819953871'
                print('페이지: ', str(i))
