...
def startCrawling(site):
    with requests.Session() as s:
        login_req = s.get('https://ssl.filemaru.com/loginPrcMaru.php?callback=loginChkCall&email=up0001@naver.com&key=dXAwMDAx&log_save=&sns_chk=&_=1558405183578', headers=headers)
        i = 0;check = True
