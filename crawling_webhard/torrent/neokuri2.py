...
def startCrawling(site):
    i = 0;check = True
    link = 'https://neokuri2.xyz/bbs/board.php?bo_table='+site+'&page='
    while check:
        i = i+1
        if i == 30:
            break
...
if __name__=='__main__':
    ...
    print("neokuri2 크롤링 시작")
    site = ['movie1', 'tv1', 'tv2', 'animation']
    for s in site:
        startCrawling(s)
    print("neokuri2 크롤링 끝")
