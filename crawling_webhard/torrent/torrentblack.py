...
def startCrawling(site):
    i = 0;check = True
    link = 'https://www.torrent-black.net/bbs/board.php?bo_table='+site+'&page='
    while check:
        i = i+1
        if i == 30:
            break
...
if __name__=='__main__':
    ...
    print("torrentblack 크롤링 시작")
    site = ['movie_new', 'kr_drama', 'kr_drama1', 'kr_ent', 'ani']
    for s in site:
        startCrawling(s)
    print("torrentblack 크롤링 끝")
