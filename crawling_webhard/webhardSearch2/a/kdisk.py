...
def startCrawling(key):
    ...
    # link = 'http://www.kdisk.co.kr/index.php?mode=kdisk&s_act=ok&sort_type=default&sub_sec=&sm_search_keyword=&sm_search=&restrict_act=N&list_count=&search_type=all&search_keyword=title&search=%BF%A9%B0%ED%BD%C4%B4%E7'
    try:
        ...
        while check:
            ...
            for item in tr:
                ...
                # if keyCheck['m'] == None:
                #     dbResult = insertDB('kdisk',resultData['Cnt_title'],title_null,url)
                #     continue
