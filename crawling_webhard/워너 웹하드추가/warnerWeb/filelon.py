...
def startCrawling(key):
    ...
    with requests.Session() as s:
        ...
        while check:
            ...
            if i == 4:
                break
            link = "http://www.filelon.com/main/storage.php?chkUser=&liststate=&s_act2=ok&s_nickname=&list_count=&search_type=&search_keyword=title&search_sort=&sub_sec=&copyrsalechk=&search="+key+"&p="
