...
def startCrawling(key):
    ...
    print('키워드: '+key)
    print("=================================")
    i = 0;check = True; startTitle = '';titleCheck = False;
    with requests.Session() as s:
        ...
        link = 'http://www.filesun.com/disk/board.php?board=1&listmode=all&sf=subject&sw='+key+'&exceptadult=1&page='
        while check:
            i = i+1
            titleCheck = False
            print('페이지: ',i)
            ...
            try:
                ...
                for item in tr:
                    ...
                    if startTitle == title_null:
                        # print('똑같애')
                        check=False;break
                    if titleCheck == False:
                        startTitle = title_null
                        titleCheck = True
