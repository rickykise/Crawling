...
headers = {
    ...
    'Host': 'buckstorrent2.xyz',
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; rv:11.0) like Gecko'
}

def startCrawling(site):
    i = 0;check = True
    link = 'https://buckstorrent2.xyz/bbs/board.php?bo_table='+site+'&page='
    while check:
        i = i+1
        if i == 30:
            break
...
if __name__=='__main__':
    ...
    print("buckstorrent2 크롤링 시작")
    site = ['mov1', 'kortv1', 'kortv2', 'animation']
    for s in site:
        startCrawling(s)
    print("buckstorrent2 크롤링 끝")
