...
def startCrawling():
    ...
    for s in sign.items():
        try:
            link = 'https://www.horoscope.com/us/horoscopes/career/horoscope-career-weekly.aspx?sign='+s[1]
            r = requests.get(link)
            c = r.content
            ...
            link2 = 'https://www.horoscope.com/us/horoscopes/career/horoscope-career-monthly.aspx?sign='+s[1]
            ...
            for i in dt_list:
                link3 = 'https://www.horoscope.com/us/horoscopes/career/horoscope-archive.aspx?sign='+s[1]+'&laDate='+i
...
if __name__=='__main__':
    ...
    print("horoscope_career 크롤링 시작")
    startCrawling()
    print("horoscope_career 크롤링 끝")
