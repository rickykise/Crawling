...
def startCrawling():
    ...
    for s in sign.items():
        try:
            link = 'https://www.horoscope.com/us/horoscopes/wellness/horoscope-wellness-weekly.aspx?sign='+s[1]
            r = requests.get(link)
            c = r.content
            ...
            link2 = 'https://www.horoscope.com/us/horoscopes/wellness/horoscope-wellness-monthly.aspx?sign='+s[1]
            ...
            dt_index = pandas.date_range(start='20190623', end='20200623')
            dt_list = dt_index.strftime("%Y%m%d").tolist()

            for i in dt_list:
                link3 = 'https://www.horoscope.com/us/horoscopes/wellness/horoscope-archive.aspx?sign='+s[1]+'&laDate='+i
...
if __name__=='__main__':
    ...
    print("horoscope_wellness 크롤링 시작")
    startCrawling()
    print("horoscope_wellness 크롤링 끝")
