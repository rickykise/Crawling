...
def startCrawling(url, keyItem):
    ...
    try:
        ...
        url2 = 'http://phimonlinehay.net/'+soup.find('a', 'xemphim')['href']
        ...
        for item in li:
            host_url = 'http://phimonlinehay.net/'+item['href']
...
if __name__=='__main__':
    ...
    print("phimonlinehay 크롤링 시작")
    for u, i in getUrl.items():
        startCrawling(u, i)
    print("phimonlinehay 크롤링 끝")
