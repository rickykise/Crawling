...
def startCrawling(url, keyItem):
    ...
    try:
        ...
        url2 = soup.find('div', 'playphim').find('a')['href'].replace('..', 'https://phimvn2.net/xem')
        ...
        for item in sub:
            host_url = 'https://phimvn2.net'+item['href']
...
if __name__=='__main__':
    ...
    print("phimvn2.net 크롤링 시작")
    for u, i in getUrl.items():
        startCrawling(u, i)
    print("phimvn2.net 크롤링 끝")
